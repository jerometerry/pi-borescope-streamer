...
> **Note:** For comprehensive build instructions—including running tests, performing static analysis (Clang-Tidy, Cppcheck), generating documentation, and setting up Visual Studio Code—please refer to the **[Build Guide (BUILD.md)](BUILD.md)**.
...
* [Running as a Video4Linux Daemon](VIDEO4LINUX.md)
