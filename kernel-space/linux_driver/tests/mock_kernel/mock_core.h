...
static inline void *vb2_plane_vaddr(struct vb2_buffer *vb, unsigned int plane_no) {
    (void)plane_no;
    return vb->mock_vaddr;
}
static inline void vb2_set_plane_payload(struct vb2_buffer *vb, unsigned int plane_no, unsigned long size) {
    (void)vb; (void)plane_no; (void)size;
}
