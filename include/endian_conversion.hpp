 ...
 *
 * @details This is a bit of overkill to be honest. This matters mostly if this code were to run on
 * big endian systems. I highly doubt that this code base will ever run on a big endian system.
 * Having said that, it isn't much trouble to add this.
 *
 */
